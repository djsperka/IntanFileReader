...
namespace Channel
{
	int convertToRHDSignalType(SignalType type);  // adjustment to maintain compatibiltiy with RHD format
	SignalType convertRHDIntToSignalType(int type);  // converting signal type ints from .rhd data files
	SignalType convertRHSIntToSignalType(int type);  // converting signal type ints from .rhs data files
};
