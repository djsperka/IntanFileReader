...
namespace AbstractRHXController {
	double getSampleRate(AmplifierSampleRate sampleRate_);
	int numAnalogIO(ControllerType type_, bool expanderConnected_);
	int numDigitalIO(ControllerType type_, bool expanderConnected_);
	string getAnalogInputChannelName(ControllerType type_, int channel_);
	string getAnalogOutputChannelName(ControllerType type_, int channel_);
	string getDigitalInputChannelName(ControllerType type_, int channel_);
	string getDigitalOutputChannelName(ControllerType type_, int channel_);
	string getAnalogIOChannelNumber(ControllerType type_, int channel_);
	string getDigitalIOChannelNumber(ControllerType type_, int channel_);

	string getBoardTypeString(ControllerType type_);
	string getSampleRateString(AmplifierSampleRate sampleRate_);
	string getStimStepSizeString(StimStepSize stepSize_);
	AmplifierSampleRate nearestSampleRate(double rate, double percentTolerance = 1.0);
	StimStepSize nearestStimStepSize(double step, double percentTolerance = 1.0);
	bool approximatelyEqual(double a, double b, double percentTolerance);
};
